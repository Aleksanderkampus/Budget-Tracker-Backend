...
namespace WebApp.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Abbreviation,Symbol")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Abbreviation,Symbol")] Currency currency)
        {
            if (id != currency.Id)
            {
                return NotFound();
